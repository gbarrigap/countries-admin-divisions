...
Address.create(street_name: 'Avenida Diego de Almagro', street_number: '2074-405', country_administrative_division: commune)
Address.create(street_name: 'Avenida Diego de Almagro', street_number: '2074-406', country_administrative_division: commune)
