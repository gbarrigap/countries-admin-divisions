...
ActiveRecord::Schema.define(version: 20180119023923) do

  create_table "addresses", force: :cascade do |t|
    t.string "street_name"
    t.string "street_number"
    t.integer "country_administrative_division_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_administrative_division_id"], name: "index_addresses_on_country_administrative_division_id"
  end
  ...
  create_table "country_administrative_levels", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_id"], name: "index_country_administrative_levels_on_country_id"
  end
